...
- A11y: both rows meet tap-target, label and contrast guidelines in light and dark; no toggle is announced in two-row mode; each row announces its own overflow controls
